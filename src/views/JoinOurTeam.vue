 ...
 <el-row>
    <el-col v-loading="loading"
      ...
      <el-steps :space="200" :active="step" simple>
        ...
        <el-step title="Xác minh bằng" icon="el-icon-document-checked"></el-step>
      </el-steps>
      <el-divider></el-divider>
      <div v-if="step == 1"> 
        <transition name="el-fade-in-linear">
          <ApplicantForm @toggleLoadding="toggleLoadding" @submitApplicant="getApplicant" />
        </transition>
      </div>
      <div v-else-if="step == 2"> 
        <transition name="el-fade-in-linear">
          <ApplicantConnection @toggleLoadding="toggleLoadding" @submitApplicant="getApplicant" :applicantGlobalVar="applicantGlobalVar" />
        </transition>
      </div>
      <div v-else-if="step == 3">
         <transition name="el-fade-in-linear">
          <ProofRequest @toggleLoadding="toggleLoadding" :applicantGlobalVar="applicantGlobalVar" />
        </transition> 
      </div>
