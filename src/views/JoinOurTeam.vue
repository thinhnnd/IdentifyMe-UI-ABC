<template>
  <el-form ref="applicantForm" :model="applicantForm" label-width="120px">
    ...
    <el-form-item label="Ngày sinh">
      <el-col :span="11">
        <el-date-picker type="date" placeholder="Pick a date" v-model="applicantForm.date_of_birth" style="width: 100%;"></el-date-picker>
      </el-col>
    </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      async onSubmit() {
        const res = await submitApplicantFormRequest(this.$data.applicantForm);
        // const res = {    
        //   id: 8, 
        ...
        //   }
        this.$router.push({ path: '/applicants/connect', name: 'ApplicantsConnections', params: { applicant : res } } )
      }
    }
  }
</script>